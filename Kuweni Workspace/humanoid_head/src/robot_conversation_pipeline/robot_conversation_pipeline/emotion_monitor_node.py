...
class EmotionMonitorNode(Node):
    def __init__(self):
        ...
        self.emotion_publisher= self.create_publisher(String, 'current_emotion', 10)
        ...
        self.emotions = ["joy", "anger", "fear", "disgust", "neutral", "sadness", "surprise"]
            ...
            with sftp.open(self.remote_file_path, 'r') as file:
                ...
                for line in new_lines:
                    ...
                    if line:
                        ...
                        self.get_logger().warn(f"EMotion got from server file {emotion}")

...
class RespeakerAudioRecorder(Node):
    def __init__(self):
        ...
        self.publisher_time = self.create_publisher(Int16, 'full_process_time', 10)
        # self.publisher_response_generation = self.create_publisher(Bool, 'response_genration_flag', 10)
        self.publisher_doa = self.create_publisher(Int32, 'doa', 10)
        ...
        self.sentence_end_threshold = 40
    ...
    def record_audio(self):
        ...
        self.pre_speech_buffer = deque(maxlen=8)
        ...
        try:
            while not self.got_a_sentence:
                ...
                if self.tuning.is_speech():# and self.tuning.is_speech():
                    true_cnt += 1
                    false_cnt = 0
                else:
                    true_cnt = 0
